...
MC_Small_5C        <- parLapply(cl, Small_5C, MonteCarlo)

stopCluster(cl)

save(MC_Small_5C, file = "MC_Small5C.RData")
...
MC_Small_10C <- parLapply(cl, Small_10C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)

save(MC_Small_10C, file = "MC_Small10C.RData")
...
clusterExport(      cl, list( "MonteCarlo" ))
MC_Small_30C   <- parLapply(cl, Small_30C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)

save(MC_Small_30C, file = "MC_Small30C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_Smallmod_5C   <- parLapply(cl, Smallmod_5C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_Smallmod_5C, file = "MC_Smallmod5C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_Smallmod_10C   <- parLapply(cl, Smallmod_10C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_Smallmod_10C, file = "MC_Smallmod10C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_Smallmod_30C   <- parLapply(cl, Smallmod_30C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_Smallmod_30C, file = "MC_Smallmod30C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_Moder_5C     <- parLapply(cl, Moder_5C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_Moder_5C, file = "MC_Moder5C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_Moder_10C     <- parLapply(cl, Moder_10C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_Moder_10C, file = "MC_Moder10C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_Moder_30C     <- parLapply(cl, Moder_30C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_Moder_30C, file = "MC_Moder30C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_NoEff_5C     <- parLapply(cl, NoEff_5C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_NoEff_5C, file = "MC_NoEff5C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_NoEff_10C     <- parLapply(cl, NoEff_10C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_NoEff_10C, file = "MC_NoEff10C.RData")
...
clusterSetRNGStream(cl, 4163370)  
clusterExport(      cl, list( "MonteCarlo" ))
MC_NoEff_30C     <- parLapply(cl, NoEff_30C, function(X) try(MonteCarlo(X),T)) 

stopCluster(cl)


save(MC_NoEff_30C, file = "MC_NoEff30C.RData")
